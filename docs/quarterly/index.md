...
月次のCore Themesをそのまま並べるのではなく、3か月を横断して**何が構造的に変わったのか、経営・Security実務の優先順位がどう動いたのか**を再編集します。

<!-- AUTO:QUARTERLY_INDEX:START -->
<div class="sil-cards sil-cards-2 sil-quarter-cards">
  <article class="sil-card">
    <a class="sil-card-title" href="2026-q2.md">Q2 2026 Security Intelligence Review</a>
    ...
    <a class="sil-card-more" href="2026-q2.md">四半期レビューを見る →</a>
  </article>
  <article class="sil-card">
    <a class="sil-card-title" href="2026-q1.md">Q1 2026 Security Intelligence Review</a>
    ...
    <a class="sil-card-more" href="2026-q1.md">四半期レビューを見る →</a>
  </article>
</div>
<!-- AUTO:QUARTERLY_INDEX:END -->
