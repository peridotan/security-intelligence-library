...
<div class="sil-category-intro"><p>サイバーセキュリティ、AI、データ保護、重要インフラ等に関する国内外の規制・政策・ガイドラインを、<strong>要求事項だけでなく経営・実務への影響</strong>まで整理します。</p></div>
...
<div class="sil-cards sil-cards-2"><article class="sil-card"><div class="sil-card-title-static">Japan</div><p>国内法令、政府方針、監督指針、業界ガイドライン。</p></article><article class="sil-card"><div class="sil-card-title-static">European Union</div><p>AI、サイバー、データ保護、製品セキュリティ関連規制。</p></article><article class="sil-card"><div class="sil-card-title-static">United States</div><p>NIST、連邦機関、規制当局、州レベルの主要動向。</p></article><article class="sil-card"><div class="sil-card-title-static">International Standards</div><p>ISO/IEC、ETSI、OECD等の標準・ベストプラクティス。</p></article></div>
